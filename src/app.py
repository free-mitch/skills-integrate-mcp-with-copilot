...
def validate_auth(teacher: dict = Depends(get_current_teacher)):
    """Validate teacher credentials and return display name"""
    return {"authenticated": True, "displayName": teacher["displayName"]}
